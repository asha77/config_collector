...
и установить Git. При установке выбрать редактор в качестве дефолтного для Git из установленных в системе (например, notepad). Остальные настройки по умолчанию.
...
Либо все вышепереречисленное прислать разработчику (asha77@gmail.com).
